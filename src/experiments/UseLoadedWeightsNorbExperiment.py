...
class UseLoadedWeightsNorbExperiment(Experiment):
    def run(self):
        ...
        norbConvolutionalAutoencoder.loadWeights("norbConvolutionalTrainingWeights.h5")

        # Obtain models
        encoder = norbConvolutionalAutoencoder.encoder()
        autoencoder = norbConvolutionalAutoencoder.autoencoder()
        decoder = norbConvolutionalAutoencoder.decoder()
