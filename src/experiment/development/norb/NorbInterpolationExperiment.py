...
class NorbInterpolationExperiment(Experiment):
    ...
    def run(self):
        ...
        norbInterpolateLoader = NorbInterpolateLoader(norbLoader)
        xInterp, yInterp = norbInterpolateLoader.loadInterpolationData()
        print(xInterp.shape, yInterp.shape)
        imagesArrayComparisonDisplay(xInterp.swapaxes(0, 1), "./out2/norbInterpolationExperiment.png", startIndex=1080, endIndex=1100)
