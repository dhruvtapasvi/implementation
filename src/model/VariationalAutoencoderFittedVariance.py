...
class VariationalAutoencoderFittedVariance(metaclass=ABCMeta):
    ...
    def __buildAutoencoder(self, encoderLayers, decoderLayers):
        ...
        decodedInputRepresentationMean, decodedInputRepresentationVariance = decoderLayers(latentRepresentation)

        self.__autoencoder = Model(inputRepresentation, decodedInputRepresentationMean)
        ...
        self.__autoencoder.compile(
            ...
            loss=variationalAutoencoderLossConstructor(
                ...
                decodedInputRepresentationVariance
            ),
            metrics=[
                self.__reconstructionLossConstructor(self.__inputRepresentationDimensions, decodedInputRepresentationVariance),
    ...
    def __buildDecoder(self, decoderLayers):
        ...
        customDecodedInputRepresentation, _ = decoderLayers(customLatentRepresentation)
