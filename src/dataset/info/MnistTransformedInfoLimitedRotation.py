...
INTERPOLATE_SHEAR_FACTORS = (-TRANSFORM_SHEAR_FACTOR, TRANSFORM_SHEAR_FACTOR, 0.0, 0.5)
INTERPOLATE_STRETCH_FACTORS = (-TRANSFORM_LOG2_STRETCH_FACTOR, TRANSFORM_LOG2_STRETCH_FACTOR, 0.0, 1.0)
...
MNIST_TRANFORMED_HOME_STEM = routes.RESOURCE_ROUTE + "/mnistTransformed_LimitedRotations_"
MNIST_TRANSFORMED_1_HOME = MNIST_TRANFORMED_HOME_STEM + "1"
MNIST_TRANSFORMED_2_HOME = MNIST_TRANFORMED_HOME_STEM + "2"
MNIST_TRANSFORMED_5_HOME = MNIST_TRANFORMED_HOME_STEM + "5"
MNIST_TRANSFORMED_10_HOME = MNIST_TRANFORMED_HOME_STEM + "10"
