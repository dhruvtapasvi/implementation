...
from model.architecture.ConvolutionalAutoencoderUnetConnections import ConvolutionalAutoencoderUnetConnections


class ConvolutionalAutoencoderConfigUnetConnections(VaeConfig):
    ...
    def fromConfig(self):
        return ConvolutionalAutoencoderUnetConnections(
