...
conv_64x64_6_16_ENC_1024_DEC_1024_LAT_32_bce = ConvolutionalDeepIntermediateAutoencoderConfig(getConfigRoute("model/convDeepIntermediate/conv_64x64_6_16_ENC_1024_DEC_1024_LAT_32_bce.json"))
conv_28x28_3_8_ENC_1024_DEC_1024_LAT_32_bce = ConvolutionalDeepIntermediateAutoencoderConfig(getConfigRoute("model/convDeepIntermediate/conv_28x28_3_8_ENC_1024_DEC_1024_LAT_32_bce.json"))
